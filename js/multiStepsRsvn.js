const JOGA_PER_HOUR = 15;
const PILATES_PER_HOUR = 10;
const ZUMBA_PER_HOUR = 12;
const TRENING_OBWODOWY_PER_HOUR = 20;
const BODY_PUMP_PER_HOUR = 20;
const FITBALL_PER_HOUR = 15;
const AEROBIK_PER_HOUR = 10;
const AQUA_AEROBIK_PER_HOUR = 20;
const ZDROWY_KREGOSLUP_PER_HOUR = 10;
const FITBOXING_PER_HOUR = 20;
const KALISTENIKA_PER_HOUR = 20;
const BRZUCH_STRETCH_PER_HOUR = 12;
