...
<section class="fitness text-center">
    <img src="image/fitness.gif" width="400" height="350" style="float:left">
        <img src="image/manfitness.png" width="390" height="370" style="float:right">
        <br/>
        <div class="container pt-lg-4 pl-4 px-4">
        <h1 class="display-3"><b>Klub fitness AleksFitness</b></h1><br/>
        <p class="lead">Witaj w naszym nowoczesnym klubie!</p> 
        <p class="lead">Miejsce, gdzie możesz poprawić swoją sylwetkę, zadbać o zdrowie, <br/>
        poznać nowych ludzi oraz się zrelakoswać.</p>
        <p class="lead">Dołącz do nas i zarezerwuj interesujący Cię trening.</p>
...
<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="image/klub2.jpg" class="d-block w-100" alt="Klub2">
      <div class="carousel-caption d-none d-md-block">
        <h2 style="color:white">Klub AleksFitness</h2> <br/>
        <p class="lead">Przygotowaliśmy dla Ciebie wiele ciekawych treningów oraz usług. Spawdź, a na pewno znajdziesz coś dla Siebie. Zapraszamy! </p>
      </div>
    </div>

    <div class="carousel-item">
      <img src="image/klub3.jpg" class="d-block w-100" alt="Klub3">
      <div class="carousel-caption d-none d-md-block">
        <h2 style="color:white">Klub AleksFitness</h2> <br/>
        <p class="lead">Doskonałe maszyny oraz narzędzia do ćwiczeń.</p>
      </div>
    </div>

  <div class="carousel-item">
      <img src="image/zestaw.jpg" class="d-block w-100" alt="Zestaw">
      <div class="carousel-caption d-none d-md-block">
        <h2 style="color: black">Klub AleksFitness</h2> <br/>
        <p class="lead" style="color: black">Możesz u nas kupić dodatkowe rzeczy do ćwiczeń!</p>
      </div>
    </div>

    <div class="carousel-item">
      <img src="image/zestaw2.jpg" class="d-block w-100" alt="Zestaw2">
    </div>

    <div class="carousel-item">
      <img src="image/mata.jpg" class="d-block w-100" alt="Mata">
      <div class="carousel-caption d-none d-md-block">
        <h2 style="color:black">Klub AleksFitness</h2> <br/>
        <p class="lead" style="color:black">Zapraszamy do naszego klubu. Przyjazna atmosfera.</p>
      </div>
    </div>
