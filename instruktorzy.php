...
<meta charset="utf-8">
    ...
    ?>
    <title>Informacje o instruktorach</title>
...
<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="image/instruktorzy/instruktor.jpg" class="d-block w-100" alt="Trener3">
      <div class="carousel-caption d-none d-md-block">
      
      <div class="container pt-lg-5 pl-5 px-5">
          <h1 class="display-3"><b>Instruktorzy - Klub AleksFitness</b></h1> 
                <p class="t">Instruktor to osoba, która promuje aktywność oraz zdrowy tryb życia. Zajmuję się prowadzeniem zajęć ruchowych: indywidualnie lub grupowo. <br/></p>
                <li class="t">prowadzenie zajęć bez obciążenia</li>
                <li class="t">prowadzenie zajęć z dodatkowym sprzętem fitness: piłki gimnastyczne, ciężarki, gumy, itd.</li>
                <li class="t">prowadzenie zajęć z aerobiku: klasyczny, step aerobik, aqua aerobik</li>
                <li class="t">prowadzenie zajęć z muzyką</li>
                <br/>

                <p class="t">Instruktorzy to osoby, które charakteryzuje:</p>
                <li class="t">dyscyplina i odpowiedzialność</li>
                <li class="t">energia i skuteczność działania</li>
                <li class="t">duże umiejetności ćwiczeń</li>
                <li class="t">naturalne przywództwo, opiekuńczość</li>
                <li class="t">łatwość w nawiązaniu kontaktu oraz wiara w możliwośći swoich podopiecznych</li>
                <li class="t">opanowanie kilkuosobowej grupy</li>
                <br/>
       </div>
    ...
    <div class="carousel-item">
      <img src="image/instruktorzy/instruktor1.jpg" class="d-block w-100" alt="Trener2">
      <div class="carousel-caption d-none d-md-block">
      <h1 class="display-3"><b>Instruktorzy - Klub AleksFitness</b></h1> 
                <p class="t">Instruktor to osoba, która promuje aktywność oraz zdrowy tryb życia. Zajmuję się prowadzeniem zajęć ruchowych: indywidualnie lub grupowo. <br/></p>
                <li class="t">prowadzenie zajęć bez obciążenia</li>
  ...
  <div class="carousel-item">
      <img src="image/instruktorzy/instruktor2.jpg" class="d-block w-100" alt="Instruktor2">
      <div class="carousel-caption d-none d-md-block">
      <h1 class="display-3"><b>Instruktorzy - Klub AleksFitness</b></h1> 
                <p class="t">Instruktor to osoba, która promuje aktywność oraz zdrowy tryb życia. Zajmuję się prowadzeniem zajęć ruchowych: indywidualnie lub grupowo. <br/></p>
                <li class="t">prowadzenie zajęć bez obciążenia</li>
