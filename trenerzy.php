...
<meta charset="utf-8">
    ...
    ?>
    <title>Informacje o trenerach</title>
...
<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="image/trenerzy/trener3.jpg" class="d-block w-100" alt="Trener3">
      <div class="carousel-caption d-none d-md-block">
      <div class="container pt-lg-5 pl-5 px-5">
          <h1 class="display-3"><b>Trenerzy - Klub AleksFitness</b></h1> 
                <p class="t">Trener personalny to przydatna osoba, która ułatwi Ci osiągnąć wymarzony cel. <br/>
                Jeśli chcesz wybrać trenera personalnego musisz zwrócić uwagę na:</p>
                <li class="t">czy posiada odpowiednie kwalifikacje</li>
                <li class="t">czy sport to jego pasja</li>
                <li class="t">czy posiada doświadczenie</li>
                <li class="t">czy rozwija swoje umiejętności oraz wiedzę dotyczącą zdrowia, kultury fizycznej</li>
                <br/>

                <p class="t">W czym może Ci pomóc taka osoba:</p>
                <li class="t">uczy najważniejszego - prawidłowego wykonywania ćwiczeń</li>
                <li class="t">rozpisuje plan treningu, bierze pod uwagę Twój stan zdrowia</li>
                <li class="t">może rozpisać dietę oraz przeprowadza pomiary: poziom tkanki tłuszczowej, mieśniowej</li>
                <li class="t">kontroluje Twoje postępy i wprowadza ewentualne modyfikacje</li>
                <li class="t">trener jest również dobrym motywatorem, wspiera i udziela wiele potrzebnych rad.</li>
                <br/>
       </div>
    ...
    <div class="carousel-item">
      <img src="image/trenerzy/trener2.jpg" class="d-block w-100" alt="Trener2">
      <div class="carousel-caption d-none d-md-block">
      <h1 class="display-3"><b>Trenerzy w klubie fitness</b></h1> 
                <p class="t">Trener personalny to przydatna osoba, która ułatwi Ci osiągnąć wymarzony cel. <br/>
                Jeśli chcesz wybrać trenera personalnego musisz zwrócić uwagę na:</p>
                <li class="t">czy posiada odpowiednie kwalifikacje</li>
                <li class="t">czy sport to jego pasja</li>
  ...
  <div class="carousel-item">
      <img src="image/trenerzy/trener1.jpg" class="d-block w-100" alt="Trener1">
      <div class="carousel-caption d-none d-md-block">
      <h1 class="display-3"><b>Trenerzy w klubie fitness</b></h1> 
                <p class="t">Trener personalny to przydatna osoba, która ułatwi Ci osiągnąć wymarzony cel. <br/>
                Jeśli chcesz wybrać trenera personalnego musisz zwrócić uwagę na:</p>
    ...
    <div class="carousel-item">
      <img src="image/trenerzy/trener.jpg" class="d-block w-100" alt="Trener">
      <div class="carousel-caption d-none d-md-block">
      <h1 class="display-3"><b>Trenerzy w klubie fitness</b></h1> 
                <p class="t">Trener personalny to przydatna osoba, która ułatwi Ci osiągnąć wymarzony cel. <br/>
                Jeśli chcesz wybrać trenera personalnego musisz zwrócić uwagę na:</p>
