...
?>
    <title>Usługi w klubie fitness</title>
...
<section class="fitness text-center">
        <div class="container pt-lg-3 pl-3 px-3">
          <h1 class="display-3"><b>Usługi w klubie AleksFitness</b></h1><br/>
            <p class="lead">Zobacz naszą ofertę dodatkowych usług. <br/> Oferujemy wiele różnych usług.</p>
...
<div class="row row-cols-1 row-cols-md-3 g-4">
  ...
  <div class="col">
    <div class="card">
      <img id="uslugi" src="image/masaz.jpg" class="card-img-top" width="400" height="320" alt="Masaż"/>
      <div class="card-body">
        <h5 class="card-title">Masaż</h5>
         <p>Miejsce, gdzie będziesz mógł się zrelaksować, zregenerować. Zadaniem masażu jest zmniejszenie napięcia mięśniowego po wysiłku 
         oraz usprawnienie przepływu krwi. </p>
      </div>
    </div>
  </div>
  ...
  <div class="col">
    <div class="card">
      <img id="uslugi" src="image/szatnia.jpg" class="card-img-top" width="400" height="320" alt="Szatnia"/>
      <div class="card-body">
  ...
  <div class="col">
    <div class="card">
      <img id="uslugi" src="image/basen.jpg" class="card-img-top" width="400" height="320" alt="Basen"/>
      <div class="card-body">
        <h5 class="card-title">Basen</h5>
        <p>Obiekt, gdzie będziesz mógł popływać. Zawieramy basen: 25 x 40 plus zatoka, głębokość jest stopniowana, basen z 8 torami.</p>
      </div>
    </div>
  </div>
  ...
  <div class="col">
    <div class="card">
      <img id="uslugi" src="image/sauna.jpg" class="card-img-top" width="400" height="320" alt="Sauna"/>
      <div class="card-body">
        <h5 class="card-title">Sauna</h5>
        <p>Obiekt, gdzie będziesz mógł się odprężyć. Panuje tam wysoka temperatura oraz wilgotność, gdzie spędzisz kilka minut.</p>
      </div>
    </div>
  </div>
