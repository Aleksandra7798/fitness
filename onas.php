...
<meta charset="utf-8">
    ...
    ?>
    <title>Informacje o klubie fitness</title>
...
<section class="fitness text-center">
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-item active">
             <img src="image/onas1.jpg" class="d-block w-100" alt="O nas">
        <div class="carousel-caption d-none d-md-block">
        <div class="kontakt-animation" data-text="Klub AleksFitness">
    </div>

   <br/><br/><br/>
    <h1 class="display-3"><b>Nowoczesny klub fitness dla każdego.</b></h1><br/>
        <p style="font-size:22px">AleksFitness to nowy powstały klub fitness, który znajduję się w Kielcach.</p><br/>
        <p style="font-size:22px">Mieści się on w galerii Korona na ulicy Warszawskiej 26, 25-312 Kielce. 
           Powstał w roku 2020 <br/>i zawiera około 2200 m<sup>2</sup> powierzchni.</p> <br/> 
           <p style="font-size:22px">Klub podzielony jest na kilka stref treningowych:</p>
        
        <div id="strefy">
            <div id="strefa1">strefa cardio</div>
            <div id="strefa2">strefa fitness</div>
        </div>
        <br/>

        <div id="strefy">
            <div id="strefa3">strefa maszyn półwolnych</div>
            <div id="strefa4">strefa wolnych ciężarów</div>
        </div>
        <br/>

        <div id="strefy">
            <div id="strefa1">strefa cross</div>
            <div id="strefa2">strefa funkcjonalna</div>
        </div>
        <br/>

        <div id="strefy">
            <div id="strefa3">basen</div>
            <div id="strefa4">strefa maszyn izotonicznych</div>
        </div>
        <br/>

        <div id="strefy">
            <div id="strefa1">strefa stretchingu</div>
            <div id="strefa2">strefa tańca (zumba)</div>
        </div> <br/><br/>

        <p style="font-size:22px">Oferujemy treningi grupowe oraz personalne z odpowiednią kadrą instruktorów oraz trenerów.</p>
        <br/>
        <p class="lead">Zapraszamy wszystkich, którzy chcą poprawić swoją kondycję oraz sylwetkę <br/>
                        - AleksFitness</p>
                ...
                <div class="modal-body" id="reservationModalBody">
                    <?php if ($isSessionExists == 1 && $isAdmin == 0) { ?>
                        <form role="form" autocomplete="off" method="post" id="multiStepRsvnForm">
                            ...
                            <p style="font-size:13px; text-align:center;">Dni otwarte: <br/>Pn-Pt: 07:00 - 23:00 <br/> 
